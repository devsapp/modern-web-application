...
export default class NewView extends Component {
    ...
    searchApp = async (noLoading = false, data = {}) => {
        ...
        data = Object.assign({}, data, { type: 'Application', sort: 'time' });
                ...
                <div className="center-content-container">
                    ...
                    <div className="app-list-container" >
                        < Loading tip="应用查询"
                            ...
                            {apps.map && apps.map((app, i) => <AppCard key={`app${i}`} data={app} initAppTemplate={this.initAppTemplate} collectApp={collectApp} collectApps={collectApps} searchApp={() => this.searchApp(true)} />)}
                        </Loading>
                    </div>
